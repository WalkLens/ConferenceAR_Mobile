...
public class DebugUserInfos : MonoBehaviour
{
   ...
   // public Button[] userButtons;
    ...
    public Button[] matchButtons;          //============ SM MODI ============//
    ...
    public HololenUIManager hololenUIManager;
    //============ SM ADD ============//
    ...
    public void OnSendURLButtonClicked()
    {
        ...
        string targetHololensNick = $"{pin}_Hololens";
    ...
    public void SetMatchButtonStatus(bool status)
    {
        if (status)
        {
            ...
            matchButtons[2].onClick.AddListener(() =>
            {
                if (matchInfo == null)
                {
                    matchInfo = new MatchInfo
            ...
            matchButtons[3].onClick.AddListener(() =>
            {
                if (matchInfo == null)
                {
                    matchInfo = new MatchInfo
    ...
    public void ShowMatchRequestUI()
    {
        ...
        hololenUIManager.AddMatchingRequestData();
        hololenUIManager.LoadMatchingSenderDataFromDB();
    }
